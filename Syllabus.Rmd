...
The final exam is a written paper (25 points) that can have a somewhat open format, as long as it is appoved by the course organizer Matt Crump. Some possibilities include:  an integrative paper that combines issues discussed across two modules, a proposal-type paper that links the student's current research interests with foundational issues discussed in one of the modules, an expansion of any of the module commentaries, or any other agreed-upon format. Final papers are expected to be in APA style, a minimum of 10-15 pages (double-spaced), and a minimum of 20 references. 
